...
import { DateRangePicker } from "@/components/EventMakePage/DateRangePicker/DateRangePicker";
import { TimeSelect } from "@/components/EventMakePage/TimeSelect";
...
const EventMakePageBodyLegacy: FC<Props> = ({ onSubmit, className }) => {
  // 時間
...
export { EventMakePageBodyLegacy };
