...
const getRequestUrl = (timeMin: Date, maxResults: number) => `${baseUri}?singleEvents=true&maxResults=${maxResults}&orderBy=startTime&timeMin=${timeMin.toISOString()}&showDeleted=false&key=${apiKey}`;
